        ...
        <div class="row">
                ...
                <table class="table text-center"><!--Creamos una tabla que mostrará todas las tareas-->
                        ...
                        <tbody>
                            <tr v-for="habitacion in habitaciones" :key="habitacion.id"> <!--Recorremos el array y cargamos nuestra tabla-->
                                ...
                                <td v-text="habitacion.hotel_id"></td>
                                <td>
            ...
            <div class="col-md-6">
                <div class="form-group"><!-- Formulario para la creación o modificación de nuestras tareas-->
                    ...
                    <label>Tipo</label>
                    <input v-model="tipo" type="text" class="form-control">
                    <label>Acomodacion</label>
                    <input v-model="acomodacion" type="text" class="form-control">
                    <label>Nombre Hotel</label>
                    <input v-model="hotel_id" type="text" class="form-control">
                </div>
                <br>
    ...
    export default {
        ...
        methods:{
            ...
            loadFieldsUpdate(data){ //Esta función rellena los campos y la variable update, con la tarea que queremos modificar
                this.update = data.id
                let me =this;
                let url = '/habitaciones/'+this.update;
                axios.get(url).then(function (response) {
